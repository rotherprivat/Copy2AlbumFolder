...
dotnet publish "Copy2AlbumFolder/Copy2AlbumFolder.csproj" -c Release -r linux-x64 -p:IncludeSourceRevisionInInformationalVersion=false --output ./Publish/linux-x64